...
import com.board.boardproject.config.TestSecurityConfig;
import com.board.boardproject.domain.type.FormStatus;
...
import com.board.boardproject.request.ArticleRequest;
import com.board.boardproject.responses.ArticleResponse;
...
class ArticleControllerTest {
    ...
    @DisplayName("[GET] 게시글 리스트 (게시판) 페이지 - 검색어와 함께 호출")
    @Test
    ...
    @DisplayName("[GET] 게시글 리스트 (게시판) 페이지 - 페이징, 정렬 기능")
    @Test
    ...
    @DisplayName("[GET] 게시글 페이지 - 인증 없을 땐 로그인 페이지로 이동")
    @Test
    ...
    @WithMockUser
    @DisplayName("[GET] 게시글 페이지 - 정상 호출, 인증된 사용자")
    @Test
    ...
    @DisplayName("[GET] 해시태그 검색 페이지 - 정상 호출")
    @Test
    public void givenNothing_whenRequestingArticleHashtagSearchView_thenReturnsArticleHashtagSearchView() throws Exception {
        // Given
        List<String> hashtags = List.of("Red", "Violet", "Teal");
    ...
    @DisplayName("[GET] 해시태그 검색 페이지 - 정상 호출, 해시태그 입력")
    @Test
